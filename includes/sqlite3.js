...
var binding_path = binary.find(path.resolve(path.join(__dirname, '../node_modules/sqlite3/', 'package.json')), {
    runtime: 'electron'
});
...
sqlite3.verbose = function() {
    if (!isVerbose) {
        var trace = require(path.join(__dirname, '../node_modules/sqlite3/lib/trace'));
        [
            'prepare',
            'get',
            'run',
